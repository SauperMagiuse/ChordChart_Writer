...
<span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> Vex.Flow === <span class="hljs-string">'undefined'</span>) {
  Vex.Flow = {
    <span class="hljs-comment">/**
     ...
     * @type {number}
     */</span>
    RESOLUTION: <span class="hljs-number">16384</span>,

    <span class="hljs-comment">/* Kerning (DEPRECATED) */</span>
    IsKerned: <span class="hljs-literal">true</span>
  };
}</pre></div>
