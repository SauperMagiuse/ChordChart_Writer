...
Vex.Flow.VoiceGroup = (<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{
  <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">VoiceGroup</span><span class="hljs-params">()</span> </span>{
...
and preformatters to associate them with the right modifierContexts.</p>
          ...
          <div class='highlight'><pre>    getVoices: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{ <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.voices; },
    getModifierContexts: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{ <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.modifierContexts; },

    addVoice: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(voice)</span> </span>{
  ...
  <span class="hljs-keyword">return</span> VoiceGroup;
}());</pre></div>
