...
Vex.Flow.TabStave = (<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{
  <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">TabStave</span><span class="hljs-params">(x, y, width, options)</span> </span>{
  ...
  Vex.Inherit(TabStave, Vex.Flow.Stave, {
    init: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(x, y, width, options)</span> </span>{
      ...
      TabStave.superclass.init.call(<span class="hljs-keyword">this</span>, x, y, width, tab_options);
    },
    ...
    addTabGlyph: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{
      <span class="hljs-keyword">var</span> glyphScale;
      <span class="hljs-keyword">var</span> glyphOffset;

      <span class="hljs-keyword">switch</span>(<span class="hljs-keyword">this</span>.options.num_lines) {
      ...
      <span class="hljs-keyword">var</span> tabGlyph = <span class="hljs-keyword">new</span> Vex.Flow.Glyph(<span class="hljs-string">"v2f"</span>, glyphScale);
      tabGlyph.y_shift = glyphOffset;
      <span class="hljs-keyword">this</span>.addGlyph(tabGlyph);
      <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
    }
  });

  <span class="hljs-keyword">return</span> TabStave;
}());</pre></div>
