...
Vex.Flow.GhostNote = (<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{
  <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">GhostNote</span><span class="hljs-params">(duration)</span> </span>{
    <span class="hljs-keyword">if</span> (<span class="hljs-built_in">arguments</span>.length &gt; <span class="hljs-number">0</span>) <span class="hljs-keyword">this</span>.init(duration);
  }

  Vex.Inherit(GhostNote, Vex.Flow.StemmableNote, {
    init: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(parameter)</span> </span>{</pre></div>
      ...
      GhostNote.superclass.init.call(<span class="hljs-keyword">this</span>, note_struct);</pre></div>
    ...
    isRest: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span> </span>{ <span class="hljs-keyword">return</span> <span class="hljs-literal">true</span>; },

    setStave: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(stave)</span> </span>{ GhostNote.superclass.setStave.call(<span class="hljs-keyword">this</span>, stave); },

    addToModifierContext: <span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">()</span>
      </span>{ <span class="hljs-comment">/* intentionally overridden */</span> <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>; },
